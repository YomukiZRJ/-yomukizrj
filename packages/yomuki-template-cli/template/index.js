    ...
    children: [
      {
        ...
        description:
          "less + eslint + prettier + jsx + vueuse + axios + lodash + pinia + vue-router",
        color: magenta,
      },
    ],
  },
    ...
    children: [
      {
        ...
        description:
          "commitlint + eslint + husky + stylelint + prettier + commitizen + jsx",
        color: blue,
      },
    ],
  },
...
const TEMPLATES = BUNDLERS.map(
  (f) => (f.children && f.children.map((v) => v.template)) || []
